...
public class SmallTests {
    public static void main(String[] argv) throws NumericalException, InvalidNotationException, ArrayException {
        ...
        Flow outlet = new Flow(new ChemicalMixture(new ChemicalSpecies[]{c}, new double[]{0.5}), 0.05);
        IsothermalUncontrolledTransientCSTR cstr = new IsothermalUncontrolledTransientCSTR(inlet, outlet, reaction, 1, new Euler());
        cstr.run(1, 1000);
